...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run protocol-aware multi-model benchmark from YAML config")
    ...
    run_cmd([
        ...
        "--results_dir", str(results_dir),
        "--bootstrap_samples", str(cfg.get("bootstrap_samples", 500)),
    ])
